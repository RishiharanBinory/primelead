  ...
  return (
    <main>
      ...
      <CoursesSection
        ...
        subheading="Explore our full range of undergraduate degrees across Business, Computing, Health, Engineering, Law and more. All courses are government funded and supported by Prime Leed from application to graduation."
      />
      <Section>
        <FAQSection />
      </Section>
