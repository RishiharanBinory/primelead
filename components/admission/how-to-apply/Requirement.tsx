...
export default function EntryRequirements() {
  return (
    <div className="w-full px-6 md:px-10 lg:px-16 py-16">
      <section
        className="w-full max-w-[1300px] mx-auto  flex flex-col md:flex-row overflow-hidden min-h-[520px]"
        style={{ backgroundColor: "#B0EAF5" }}
      >
        {/* ── Left Content ── */}
        <div className="flex-none w-full md:w-[38%] px-12 py-16 flex flex-col justify-center">
          <h2
            className="font-extrabold text-[44px] lg:text-[56px] leading-[1.08] mb-6 tracking-tight"
            style={{ color: "#0d2b3e" }}
          >
            Entry<br />Requirements
          </h2>

          <div className="flex flex-col gap-0.5 mb-10 max-w-[300px]">
          ...
          <div className="w-100 border-t border-slate-600/25 mb-8" />
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-10">
          {/* No border-radius on the background rectangle per requirements */}
          <div
          ...
          >
            <div className="grid grid-cols-2 gap-5">
              {requirementCards.map((card, i) => (
                <div
                  key={i}
                  className="bg-white rounded-2xl p-6 flex flex-col gap-4 transition-transform duration-200 hover:-translate-y-1"
