  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] md:text-xs text-gray-500">{review.date}</p>
          </div>
        </div>
        <svg viewBox="0 0 24 24" width="22" height="22" fill="#1877F2" className="shrink-0">
      ...
      <div className="flex gap-0.5">
        {[...Array(5)].map((_, i) => (
          <svg key={i} width="15" height="15" viewBox="0 0 16 16" fill="#1877F2">
